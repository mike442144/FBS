<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlogCategoryList.aspx.cs" Inherits="FBS.Web.News.Admin.Pages.BlogCategoryPages.BlogCategoryList" %>
...
<asp:GridView  ID="ArticlesGridView" Width="688px" AllowPaging=True  runat="server"  Font-Size="12px"  RowStyle-CssClass="row-style"
            DataKeyNames="BlogCategoryID" OnRowDeleting="Row_Deleted" 
   ...
   <HeaderStyle   Font-Bold= "True "   HorizontalAlign= "Center "   ForeColor="White"  BackColor= "#3198CA " Height="32px"   Font-Size="Small"> </HeaderStyle>
    ...
    <Columns>
    <asp:BoundField DataField="BlogCategoryID" Visible="false"  ReadOnly="true" />
    <asp:HyperLinkField DataTextField="CategoryName" DataNavigateUrlFormatString="UpdateBlogCategory.aspx?id={0}"  DataNavigateUrlFields="BlogCategoryID"   HeaderText="博客分类名称"/>
   ...
   <asp:BoundField DataField="Description"   HeaderText="描述"  >
    ...
    <asp:TemplateField HeaderText="删除">
        <ItemTemplate>
            ...
            <asp:ImageButton ID="ImageButton1" ImageUrl="~/Admin/images/del.gif" runat="server" CausesValidation="false" CommandName="Delete" Text="删 除"  Width="15px" Height="15px" BackColor="#FFFFFF" BorderStyle="None" ForeColor="#000000"  OnClientClick="return confirm('删除此分类，此分类下的文章将一同被删除，您确认删除该记录吗?');" />
             </ItemTemplate>
        <ItemStyle HorizontalAlign="Center" />
    </asp:TemplateField>
