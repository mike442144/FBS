<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateQuestionCategory.aspx.cs" Inherits="Aviator.Web.Admin.Pages.QuestionCategoryPages.UpdateQuestionCategory" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>更新博客问题分类</title>
...
<body>
    <form id="form2" method="post" action="UpdateQuestionCategory.aspx">
    ...
    <td class="style1">
        ...
        <input type="hidden" value="<%=myid %>" name="categoryid" id="categoryid" />
                    </td>
