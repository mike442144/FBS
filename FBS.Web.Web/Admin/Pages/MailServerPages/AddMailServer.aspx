<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMailServer.aspx.cs" Inherits="Aviator.Web.Admin.AddMailServer" %>
...
<body>
    ...
    <td class="style1">
        <asp:TextBox ID="TB_ServerName" runat="server" class="input"></asp:TextBox>
                    </td>
    </tr>
     <tr>
    ...
    <td class="style1">
        <asp:CheckBox ID="CHB_ON" Text="开启" runat="server" Checked=true AutoPostBack="True"  Font-Size="12px"
     ...
     <tr>
    <td class="style2">
        <asp:Button ID="BT_AddServer" runat="server" Text="增加服务器"  class="button"
