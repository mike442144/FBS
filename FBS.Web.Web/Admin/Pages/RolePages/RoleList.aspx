<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleList.aspx.cs" Inherits="FBS.Web.News.Admin.RoleList" %>
...
<td style="right"> <a href="AddRole.aspx"><br /> <img src="../../images/add.gif" border="0px"/> 新增</a></td></tr><br />
	<tr>
		<td valign="middle" background="../../images/mail_leftbg.gif">&nbsp;</td>
		<td valign="top" bgcolor="#F7F8F9" align="center" class="list1">
  
    <asp:GridView ID="RolesGridView" runat="server" DataKeyNames="Name"  
            ...
            style="margin-right: 34px" Width="417px" >
...
<RowStyle CssClass="row-style"></RowStyle>
    ...
    <asp:HyperLinkField DataTextField="Test" DataNavigateUrlFormatString="UpdateRole.aspx?id={0}"  DataNavigateUrlFields="Name"   HeaderText="角色名称"/>
