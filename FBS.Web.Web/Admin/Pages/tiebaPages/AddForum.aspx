<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddForum.aspx.cs" Inherits="FBS.Web.News.Admin.Pages.tiebaPages.AddForum" %>
...
<body>
    ...
    <td class="style2" colspan="2">
        <asp:Button ID="BT_AddForum" runat="server" Text="添加贴吧"  class="button"
            onclick="BT_AddForum_Click" />
        </td>
    </tr>
    </table>
    </div>
