...
namespace FBS.Utils
{
    ...
    public class Utils
    {
        ...
        {
            return FBS.Utils.AviatorWebRequest.GetIP();
        }
        ...
        /// <param name="length">汲取的长度英文字符的长度</param>
        /// <returns></returns>
        public static string M_SubString(string stringToSub, int length)
        {
        ...
        /// <returns></returns>
        public static int GetStringCount(string stringToSub)
        {
            Regex regex = new Regex("[\u4e00-\u9fa5]+", RegexOptions.Compiled);
            char[] stringChar = stringToSub.ToCharArray();
            int nLength = 0;
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        public static string RemoveImgTag(string content)
        {
            return Regex.Replace(content, @"<img\s+[^>]>", string.Empty, RegexOptions.IgnoreCase);
        }
    }
}
